...
## 課程心得
資料結構與演算法這堂課在我們巨量資料的領域是不可或缺的知識，剛開始的時候其實我也蠻排斥蔡老師的授課方式，尤其是作業方面，老實說蠻花時間的。但是慢慢的發現原來在這堂課下，我慢慢建立起了自己的自學模式，這對我來說是一個收穫。我也發現了其實網路上的學習資源很多，都是寶藏，差的就是你有沒有毅力去發掘去學習。還有一點就是我本身是還好啦~ 就是如果你程式基礎不夠，我有以下幾點建議:
...
最後，謝謝`蔡老師`和`助教`陪我走完這學期，也因為遇到你們我才知道我現在正走在哪條路上。
